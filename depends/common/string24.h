/*
 * This is the implementation of VS2008 basic_string class which is
 * compatible with VS2015 basic_string structure, achieved by removing
...
template<class _Elem,
    ...
    class basic_string24;

        // TEMPLATE CLASS _String24_const_iterator
template<class _Elem,
    class _Traits,
    class _Alloc>
    class _String24_const_iterator
...
public:
    typedef _String24_const_iterator<_Elem, _Traits, _Alloc> _MyType;
    typedef basic_string24<_Elem, _Traits, _Alloc> _Mystring;
...
//#endif
 ...
 #define _STRING24_CONST_ITERATOR(ptr)    const_iterator(ptr)
    ...
    _MyType& __CLR_OR_THIS_CALL operator++()
        {    // preincrement
        if (this->_Mycont != _IGNORE_MYCONT)
        {
            //_SCL_SECURE_VALIDATE(this->_Has_container());
    ...
    _MyType __CLR_OR_THIS_CALL operator++(int)
        {    // postincrement
        _MyType _Tmp = *this;
        ++*this;
        return (_Tmp);
    ...
    _MyType& __CLR_OR_THIS_CALL operator+=(difference_type _Off)
    ...
    _MyType __CLR_OR_THIS_CALL operator+(difference_type _Off) const
        {    // return this + integer
        _MyType _Tmp = *this;
        return (_Tmp += _Off);
        }
    ...
    difference_type __CLR_OR_THIS_CALL operator-(const _MyType& _Right) const
    ...
    bool __CLR_OR_THIS_CALL operator==(const _MyType& _Right) const
 ...
 #if _HAS_ITERATOR_DEBUGGING
    void __CLR_OR_THIS_CALL _Compat(const _MyType& _Right) const
...
template<class _Elem,
    class _Traits,
    class _Alloc> inline
    _String24_const_iterator<_Elem, _Traits, _Alloc> __CLRCALL_OR_CDECL operator+(
        typename _String24_const_iterator<_Elem, _Traits, _Alloc>
            ::difference_type _Off,
        _String24_const_iterator<_Elem, _Traits, _Alloc> _Next)
    {    // add offset to iterator
    return (_Next += _Off);
    }

        // TEMPLATE CLASS _String24_iterator
template<class _Elem,
    class _Traits,
    class _Alloc>
    class _String24_iterator
        : public _String24_const_iterator<_Elem, _Traits, _Alloc>
    {    // iterator for mutable string
public:
    typedef _String24_iterator<_Elem, _Traits, _Alloc> _MyType;
    typedef _String24_const_iterator<_Elem, _Traits, _Alloc> _Mybase;
    ...
    __CLR_OR_THIS_CALL _String24_iterator()
...
template<class _Elem,
    class _Traits,
    class _Alloc> inline
    _String24_iterator<_Elem, _Traits, _Alloc> __CLR_OR_THIS_CALL operator+(
        typename _String24_iterator<_Elem, _Traits, _Alloc>
            ::difference_type _Off,
        _String24_iterator<_Elem, _Traits, _Alloc> _Next)
    {    // add offset to iterator
    return (_Next += _Off);
    }

        // TEMPLATE CLASS _String24_val
template<class _Type,
    class _Alloc>
    class _String24_val
        : public _String_base
    {    // base class for basic_string24 to hold allocator _Alval
protected:
    typedef typename _Alloc::template
        rebind<_Type>::other _Alty;

    __CLR_OR_THIS_CALL _String24_val(_Alty _Al = _Alty())
        //: _Alval(_Al)
        {    // construct allocator from _Al
        }

public:
    __CLR_OR_THIS_CALL _String24_val(const _String24_val &_Right)
...
protected:
    ...
    //_Alty _Alval;    // allocator object for strings
        ...
        // TEMPLATE CLASS basic_string24
template<class _Elem,
    class _Traits,
    class _Ax>
    class basic_string24
        : public _String24_val<_Elem, _Ax>
    {    // null-terminated transparent array of elements
public:
    typedef basic_string24<_Elem, _Traits, _Ax> _MyType;
    typedef _String24_val<_Elem, _Ax> _Mybase;
...
#define _STR_ITER_BASE(it)    (it)._Myptr
    ...
    typedef _String24_iterator<_Elem, _Traits, _Alloc> iterator;
    typedef _String24_const_iterator<_Elem, _Traits, _Alloc> const_iterator;

//    friend class _String24_iterator<_Elem, _Traits, _Alloc>;
    friend class _String24_const_iterator<_Elem, _Traits, _Alloc>;
    ...
    */
    #if _DEFINE_DLL_OVERLOADS || (defined(_DEBUG) && !_HAS_ITERATOR_DEBUGGING)
    ...
    __CLR_OR_THIS_CALL basic_string24()
        : _Mybase()
    ...
    __CLR_OR_THIS_CALL basic_string24(_Has_debug_it _Hdi = _Has_debug_it(true))
        : _Mybase()
        {    // construct empty string
        if (!_Hdi._Value)
            {
    ...
    __CLR_OR_THIS_CALL basic_string24(_Has_debug_it _Hdi = _Has_debug_it(false))
        : _Mybase()
        {    // construct empty string
        if (!_Hdi._Value)
            {
    ...
    explicit __CLR_OR_THIS_CALL basic_string24(const _Alloc& _Al)
        : _Mybase(_Al)
        {    // construct empty string with allocator
        _Tidy();
        }

    __CLR_OR_THIS_CALL basic_string24(const _MyType& _Right, size_type _Roff,
    ...
    __CLR_OR_THIS_CALL basic_string24(const _MyType& _Right, size_type _Roff, size_type _Count,
        const _Alloc& _Al)
        : _Mybase(_Al)
    ...
    __CLR_OR_THIS_CALL basic_string24(const _Elem *_Ptr, size_type _Count)
        : _Mybase()
    ...
    __CLR_OR_THIS_CALL basic_string24(const _Elem *_Ptr, size_type _Count, const _Alloc& _Al)
        : _Mybase(_Al)
    ...
    __CLR_OR_THIS_CALL basic_string24(const _Elem *_Ptr)
        : _Mybase()
    ...
    __CLR_OR_THIS_CALL basic_string24(const _Elem *_Ptr, const _Alloc& _Al)
        : _Mybase(_Al)
    ...
    __CLR_OR_THIS_CALL basic_string24(size_type _Count, _Elem _Ch)
        : _Mybase()
    ...
    __CLR_OR_THIS_CALL basic_string24(size_type _Count, _Elem _Ch, const _Alloc& _Al)
        : _Mybase(_Al)
    ...
    template<class _It>
        __CLR_OR_THIS_CALL basic_string24(_It _First, _It _Last)
        : _Mybase()
    ...
    template<class _It>
        __CLR_OR_THIS_CALL basic_string24(_It _First, _It _Last, const _Alloc& _Al)
        : _Mybase(_Al)
    ...
    __CLR_OR_THIS_CALL basic_string24(const_pointer _First, const_pointer _Last)
        : _Mybase()
    ...
    __CLR_OR_THIS_CALL basic_string24(const_iterator _First, const_iterator _Last)
        : _Mybase()
    ...
    __CLR_OR_THIS_CALL basic_string24(const _MyType& _Right)
        : _Mybase(_Right)
 ...
 #if defined(_DEBUG) && defined(_DLL_CPPLIB)

  #if _DEFINE_DLL_OVERLOADS || !_HAS_ITERATOR_DEBUGGING

    explicit __CLR_OR_THIS_CALL basic_string24(const _Alloc& _Al, _NO_DEBUG_PLACEHOLDER)
        : _Mybase(_Al)
        {    // construct empty string with allocator
        this->_Myfirstiter = _IGNORE_MYITERLIST;
        _Tidy();
    ...
    __CLR_OR_THIS_CALL basic_string24(const _MyType& _Right, _No_debug_placeholder)
    ...
    __CLR_OR_THIS_CALL basic_string24(const _MyType& _Right, size_type _Roff, _NO_DEBUG_PLACEHOLDER)
        : _Mybase(_Right._Alval())
        {    // construct from _Right [_Roff, _Roff + _Count)
        this->_Myfirstiter = _IGNORE_MYITERLIST;
        _Tidy();
    ...
    __CLR_OR_THIS_CALL basic_string24(const _MyType& _Right, size_type _Roff,
        size_type _Count, _NO_DEBUG_PLACEHOLDER)
        : _Mybase()
        {    // construct from _Right [_Roff, _Roff + _Count)
        this->_Myfirstiter = _IGNORE_MYITERLIST;
        _Tidy();
    ...
    __CLR_OR_THIS_CALL basic_string24(const _MyType& _Right, size_type _Roff, size_type _Count,
        const _Alloc& _Al, _NO_DEBUG_PLACEHOLDER)
        : _Mybase(_Al)
        {    // construct from _Right [_Roff, _Roff + _Count) with allocator
        this->_Myfirstiter = _IGNORE_MYITERLIST;
        _Tidy();
    ...
    __CLR_OR_THIS_CALL basic_string24(const _Elem *_Ptr, size_type _Count, _NO_DEBUG_PLACEHOLDER)
        : _Mybase()
        {    // construct from [_Ptr, _Ptr + _Count)
        this->_Myfirstiter = _IGNORE_MYITERLIST;
        _Tidy();
    ...
    __CLR_OR_THIS_CALL basic_string24(const _Elem *_Ptr, _NO_DEBUG_PLACEHOLDER)
        : _Mybase()
        {    // construct from [_Ptr, <null>)
        this->_Myfirstiter = _IGNORE_MYITERLIST;
        _Tidy();
    ...
    __CLR_OR_THIS_CALL basic_string24(const _Elem *_Ptr, const _Alloc& _Al, _NO_DEBUG_PLACEHOLDER)
        : _Mybase(_Al)
        {    // construct from [_Ptr, <null>) with allocator
        this->_Myfirstiter = _IGNORE_MYITERLIST;
        _Tidy();
    ...
    __CLR_OR_THIS_CALL basic_string24(size_type _Count, _Elem _Ch, _NO_DEBUG_PLACEHOLDER)
        : _Mybase()
        {    // construct from _Count * _Ch
        this->_Myfirstiter = _IGNORE_MYITERLIST;
        _Tidy();
    ...
    __CLR_OR_THIS_CALL basic_string24(size_type _Count, _Elem _Ch, const _Alloc& _Al, _NO_DEBUG_PLACEHOLDER)
        : _Mybase(_Al)
        {    // construct from _Count * _Ch with allocator
        this->_Myfirstiter = _IGNORE_MYITERLIST;
        _Tidy();
    ...
    template<class _It>
        __CLR_OR_THIS_CALL basic_string24(_It _First, _It _Last, _NO_DEBUG_PLACEHOLDER)
        : _Mybase()
        {    // construct from [_First, _Last)
        this->_Myfirstiter = _IGNORE_MYITERLIST;
        _Tidy();
    ...
    template<class _It>
        __CLR_OR_THIS_CALL basic_string24(_It _First, _It _Last, const _Alloc& _Al, _NO_DEBUG_PLACEHOLDER)
        : _Mybase(_Al)
        {    // construct from [_First, _Last) with allocator
        this->_Myfirstiter = _IGNORE_MYITERLIST;
        _Tidy();
    ...
    __CLR_OR_THIS_CALL basic_string24(const_pointer _First, const_pointer _Last, _NO_DEBUG_PLACEHOLDER)
        : _Mybase()
        {    // construct from [_First, _Last), const pointers
        this->_Myfirstiter = _IGNORE_MYITERLIST;
        _Tidy();
    ...
    __CLR_OR_THIS_CALL basic_string24(const_iterator _First, const_iterator _Last, _NO_DEBUG_PLACEHOLDER)
        : _Mybase()
        {    // construct from [_First, _Last), const_iterators
        this->_Myfirstiter = _IGNORE_MYITERLIST;
        _Tidy();
  ...
  #endif /* _DEFINE_DLL_OVERLOADS || !_HAS_ITERATOR_DEBUGGING */
    ...
    _MyType& __CLR_OR_THIS_CALL operator=(const _MyType& _Right)
        {    // assign _Right
        return (assign(_Right));
        }

    _MyType& __CLR_OR_THIS_CALL operator=(const _Elem *_Ptr)
        {    // assign [_Ptr, <null>)
        return (assign(_Ptr));
        }

    _MyType& __CLR_OR_THIS_CALL operator=(_Elem _Ch)
        {    // assign 1 * _Ch
        return (assign(1, _Ch));
        }
    ...
    _MyType& __CLR_OR_THIS_CALL append(const _MyType& _Right)
        {    // append _Right
    ...
    _MyType& __CLR_OR_THIS_CALL append(const _Elem *_Ptr, size_type _Count)
    ...
    _MyType& __CLR_OR_THIS_CALL append(const _Elem *_Ptr)
        {    // append [_Ptr, <null>)
        _DEBUG_POINTER(_Ptr);
        return (append(_Ptr, _Traits::length(_Ptr)));
        }

    _MyType& __CLR_OR_THIS_CALL append(size_type _Count, _Elem _Ch)
        {    // append _Count * _Ch
    ...
    template<class _It>
        _MyType& __CLR_OR_THIS_CALL append(_It _First, _It _Last)
        {    // append [_First, _Last)
        return (_Append(_First, _Last, _Iter_cat(_First)));
        }

    template<class _It>
        _MyType& __CLR_OR_THIS_CALL _Append(_It _Count, _It _Ch, _Int_iterator_tag)
        {    // append _Count * _Ch
        return (append((size_type)_Count, (_Elem)_Ch));
        }

    template<class _It>
        _MyType& __CLR_OR_THIS_CALL _Append(_It _First, _It _Last, input_iterator_tag)
        {    // append [_First, _Last), input iterators
        return (replace(end(), end(), _First, _Last));
        }

    _MyType& __CLR_OR_THIS_CALL append(const_pointer _First, const_pointer _Last)
        {    // append [_First, _Last), const pointers
        return (replace(end(), end(), _First, _Last));
        }

    _MyType& __CLR_OR_THIS_CALL append(const_iterator _First, const_iterator _Last)
        {    // append [_First, _Last), const_iterators
        return (replace(end(), end(), _First, _Last));
        }

    _MyType& __CLR_OR_THIS_CALL assign(const _MyType& _Right)
        {    // assign _Right
    ...
    _MyType& __CLR_OR_THIS_CALL assign(const _Elem *_Ptr, size_type _Count)
    ...
    _MyType& __CLR_OR_THIS_CALL assign(const _Elem *_Ptr)
        {    // assign [_Ptr, <null>)
        _DEBUG_POINTER(_Ptr);
        return (assign(_Ptr, _Traits::length(_Ptr)));
        }

    _MyType& __CLR_OR_THIS_CALL assign(size_type _Count, _Elem _Ch)
        {    // assign _Count * _Ch
        if (_Count == npos)
            _String_base::_Xlen();    // result too long
    ...
    template<class _It>
        _MyType& __CLR_OR_THIS_CALL assign(_It _First, _It _Last)
        {    // assign [First, _Last)
        return (_Assign(_First, _Last, _Iter_cat(_First)));
        }

    template<class _It>
        _MyType& __CLR_OR_THIS_CALL _Assign(_It _Count, _It _Ch, _Int_iterator_tag)
        {    // assign _Count * _Ch
        return (assign((size_type)_Count, (_Elem)_Ch));
        }

    template<class _It>
        _MyType& __CLR_OR_THIS_CALL _Assign(_It _First, _It _Last, input_iterator_tag)
        {    // assign [First, _Last), input iterators
        return (replace(begin(), end(), _First, _Last));
        }

    _MyType& __CLR_OR_THIS_CALL assign(const_pointer _First, const_pointer _Last)
        {    // assign [First, _Last), const pointers
        return (replace(begin(), end(), _First, _Last));
        }

    _MyType& __CLR_OR_THIS_CALL assign(const_iterator _First, const_iterator _Last)
        {    // assign [First, _Last), const_iterators
        return (replace(begin(), end(), _First, _Last));
        }

    _MyType& __CLR_OR_THIS_CALL insert(size_type _Off, const _MyType& _Right)
        {    // insert _Right at _Off
        return (insert(_Off, _Right, 0, npos));
        }

    _MyType& __CLR_OR_THIS_CALL insert(size_type _Off,
        const _MyType& _Right, size_type _Roff, size_type _Count)
    ...
    _MyType& __CLR_OR_THIS_CALL insert(size_type _Off, const _Elem *_Ptr)
    ...
    _MyType& __CLR_OR_THIS_CALL erase(size_type _Off = 0,
        size_type _Count = npos)
    ...
    _MyType& __CLR_OR_THIS_CALL replace(size_type _Off, size_type _N0, const _MyType& _Right)
        {    // replace [_Off, _Off + _N0) with _Right
        return (replace(_Off, _N0, _Right, 0, npos));
        }

    _MyType& __CLR_OR_THIS_CALL replace(size_type _Off,
        size_type _N0, const _MyType& _Right, size_type _Roff, size_type _Count)
    ...
    _MyType& __CLR_OR_THIS_CALL replace(size_type _Off, size_type _N0, const _Elem *_Ptr)
    ...
    _MyType& __CLR_OR_THIS_CALL replace(const_iterator _First, const_iterator _Last, const _MyType& _Right)
        {    // replace [_First, _Last) with _Right
        return (replace(
            _Pdif(_First, begin()), _Pdif(_Last, _First), _Right));
        }

    _MyType& __CLR_OR_THIS_CALL replace(const_iterator _First, const_iterator _Last, const _Elem *_Ptr,
        size_type _Count)
    ...
    _MyType& __CLR_OR_THIS_CALL replace(const_iterator _First, const_iterator _Last,
        size_type _Count, _Elem _Ch)
    ...
    template<class _It>
        _MyType& __CLR_OR_THIS_CALL _Replace(const_iterator _First, const_iterator _Last,
  ...
  //#endif /* _DEFINE_DLL_OVERLOADS || !_SECURE_SCL */
    ...
    void __CLR_OR_THIS_CALL swap(_MyType& _Right)
    ...
    size_type __CLR_OR_THIS_CALL find(const _MyType& _Right, size_type _Off = 0) const
    ...
    size_type __CLR_OR_THIS_CALL rfind(const _MyType& _Right, size_type _Off = npos) const
    ...
    size_type __CLR_OR_THIS_CALL find_first_of(const _MyType& _Right,
    ...
    size_type __CLR_OR_THIS_CALL find_last_of(const _MyType& _Right,
    ...
    size_type __CLR_OR_THIS_CALL find_first_not_of(const _MyType& _Right,
        size_type _Off = 0) const
    ...
    size_type __CLR_OR_THIS_CALL find_last_not_of(const _MyType& _Right,
        size_type _Off = npos) const
    ...
    _MyType __CLR_OR_THIS_CALL substr(size_type _Off = 0, size_type _Count = npos) const
        {    // return [_Off, _Off + _Count) as new string
        return (_MyType(*this, _Off, _Count, get_allocator()));
        }

    int __CLR_OR_THIS_CALL compare(const _MyType& _Right) const
    ...
    int __CLR_OR_THIS_CALL compare(size_type _Off,
        size_type _N0, const _MyType& _Right,
...
protected:
    ...
    // basic_string24 implements a performant swap
template<class _Elem, class _Traits, class _Ax>
    class _Move_operation_category<basic_string24<_Elem, _Traits, _Ax> >
    {
    public:
...
template<class _Elem,
    class _Traits,
    class _Alloc>
    _PGLOBAL const typename basic_string24<_Elem, _Traits, _Alloc>::size_type
        basic_string24<_Elem, _Traits, _Alloc>::npos =
            (typename basic_string24<_Elem, _Traits, _Alloc>::size_type)(-1);

        // basic_string24 TEMPLATE OPERATORS

template<class _Elem,
    class _Traits,
    class _Alloc> inline
    void __CLRCALL_OR_CDECL swap(basic_string24<_Elem, _Traits, _Alloc>& _Left,
        basic_string24<_Elem, _Traits, _Alloc>& _Right)
    {    // swap _Left and _Right strings
    _Left.swap(_Right);
    }

typedef basic_string24<char, char_traits<char>, allocator<char> >
    string24;
typedef basic_string24<wchar_t, char_traits<wchar_t>, allocator<wchar_t> >
    wstring24;

        // basic_string24 TEMPLATE OPERATORS FROM <string>
template<class _Elem,
	class _Traits,
	class _Alloc> inline
	basic_string24<_Elem, _Traits, _Alloc> __CLRCALL_OR_CDECL operator+(
		const basic_string24<_Elem, _Traits, _Alloc>& _Left,
		const basic_string24<_Elem, _Traits, _Alloc>& _Right)
	{	// return string + string
	return (basic_string24<_Elem, _Traits, _Alloc>(_Left) += _Right);
	}
...
template<class _Elem,
	...
	return (basic_string24<_Elem, _Traits, _Alloc>(1, _Left) += _Right);
	}
