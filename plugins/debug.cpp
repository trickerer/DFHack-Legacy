...
Copyright © 2020 Trickerer <onlysuffering@gmail.com>
...
//    tthread::lock_guard<tthread::mutex> lock(manager.access_mutex_);
//    out << std::left;
...
//    }
//
//    DebugCategory::level filterLevel = static_cast<DebugCategory::level>(iter - levelNames.begin());
//
//    unsigned line = 0;
