...
#define FAIL_PTR(message) FAIL((stl_sprintf("0x%016x: ", reinterpret_cast<uintptr_t>(base)) + message).c_str())
#else
#define UNINIT_PTR 0xd2d2d2d2
#define FAIL_PTR(message) FAIL((stl_sprintf("0x%08x: ", reinterpret_cast<uintptr_t>(base)) + message).c_str())
#endif
