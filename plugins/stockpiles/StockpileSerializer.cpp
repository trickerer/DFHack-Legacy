...
void StockpileSerializer::FuncWriteExport::operator()(const std::string &id)
{
    switch (cat)
    {
        case ITEM_C_MEAT:               buf->mutable_food()->add_meat(id);                      break;
        case ITEM_C_FISH:               buf->mutable_food()->add_fish(id);                      break;
        case ITEM_C_UNPREP_FISH:        buf->mutable_food()->add_unprepared_fish(id);           break;
        case ITEM_C_EGGS:               buf->mutable_food()->add_egg(id);                       break;
        case ITEM_C_PLANTS:             buf->mutable_food()->add_plants(id);                    break;
        case ITEM_C_PLANTDRINK:         buf->mutable_food()->add_drink_plant(id);               break;
        case ITEM_C_CREATDRINK:         buf->mutable_food()->add_drink_animal(id);              break;
        case ITEM_C_PLANTCHEESE:        buf->mutable_food()->add_cheese_plant(id);              break;
        case ITEM_C_CREATCHEESE:        buf->mutable_food()->add_cheese_animal(id);             break;
        case ITEM_C_SEED:               buf->mutable_food()->add_seeds(id);                     break;
        case ITEM_C_LEAF:               buf->mutable_food()->add_leaves(id);                    break;
        case ITEM_C_PLANTPOWDER:        buf->mutable_food()->add_powder_plant(id);              break;
        case ITEM_C_CREATPOWDER:        buf->mutable_food()->add_powder_creature(id);           break;
        case ITEM_C_GLOB:               buf->mutable_food()->add_glob(id);                      break;
        case ITEM_C_PLANTLIQUID:        buf->mutable_food()->add_liquid_plant(id);              break;
        case ITEM_C_CREATLIQUID:        buf->mutable_food()->add_liquid_animal(id);             break;
        case ITEM_C_MISCLIQUID:         buf->mutable_food()->add_liquid_misc(id);               break;
        case ITEM_C_PASTE:              buf->mutable_food()->add_glob_paste(id);                break;
        case ITEM_C_PRESSED:            buf->mutable_food()->add_glob_pressed(id);              break;
        case ITEM_T_LEATHER:            buf->mutable_leather()->add_mats(id);                   break;
        case ITEM_T_FURNITURE:          buf->mutable_furniture()->add_mats(id);                 break;
        case ITEM_T_FURNITURE_OTHER:    buf->mutable_furniture()->add_other_mats(id);           break;
        case ITEM_Q_FURNITURE_CORE:     buf->mutable_furniture()->add_quality_core(id);         break;
        case ITEM_Q_FURNITURE_TOTAL:    buf->mutable_furniture()->add_quality_total(id);        break;
        case ITEM_T_REFUSE:             buf->mutable_refuse()->add_type(id);                    break;
        case ITEM_T_REFUSE_CORPSE:      buf->mutable_refuse()->add_corpses(id);                 break;
        case ITEM_T_REFUSE_PART:        buf->mutable_refuse()->add_body_parts(id);              break;
        case ITEM_T_REFUSE_SKULL:       buf->mutable_refuse()->add_skulls(id);                  break;
        case ITEM_T_REFUSE_BONE:        buf->mutable_refuse()->add_bones(id);                   break;
        case ITEM_T_REFUSE_HAIR:        buf->mutable_refuse()->add_hair(id);                    break;
        case ITEM_T_REFUSE_SHELL:       buf->mutable_refuse()->add_shells(id);                  break;
        case ITEM_T_REFUSE_TEETH:       buf->mutable_refuse()->add_teeth(id);                   break;
        case ITEM_T_REFUSE_HORN:        buf->mutable_refuse()->add_horns(id);                   break;
        case ITEM_T_STONE:              buf->mutable_stone()->add_mats(id);                     break;
        case ITEM_T_AMMO_TYPE:          buf->mutable_ammo()->add_type(id);                      break;
        case ITEM_T_AMMO_MATS:          buf->mutable_ammo()->add_mats(id);                      break;
        case ITEM_Q_AMMO_CORE:          buf->mutable_ammo()->add_quality_core(id);              break;
        case ITEM_Q_AMMO_TOTAL:         buf->mutable_ammo()->add_quality_total(id);             break;
        case ITEM_T_COIN_MATS:          buf->mutable_coin()->add_mats(id);                      break;
        case ITEM_T_BAR_MATS:           buf->mutable_barsblocks()->add_bars_mats(id);           break;
        case ITEM_T_BAR_MATS_O:         buf->mutable_barsblocks()->add_bars_other_mats(id);     break;
        case ITEM_T_BLK_MATS:           buf->mutable_barsblocks()->add_blocks_mats(id);         break;
        case ITEM_T_BLK_MATS_O:         buf->mutable_barsblocks()->add_blocks_other_mats(id);   break;
        case ITEM_T_GEM_R_MATS:         buf->mutable_gems()->add_rough_mats(id);                break;
        case ITEM_T_GEM_C_MATS:         buf->mutable_gems()->add_cut_mats(id);                  break;
        case ITEM_T_FGOOD_TYPE:         buf->mutable_finished_goods()->add_type(id);            break;
        case ITEM_T_FGOOD_MATS:         buf->mutable_finished_goods()->add_mats(id);            break;
        case ITEM_T_FGOOD_MATS_O:       buf->mutable_finished_goods()->add_other_mats(id);      break;
        case ITEM_Q_FGOOD_CORE:         buf->mutable_finished_goods()->add_quality_core(id);    break;
        case ITEM_Q_FGOOD_TOTAL:        buf->mutable_finished_goods()->add_quality_total(id);   break;
        case ITEM_T_CLOTH_T_SILK:       buf->mutable_cloth()->add_thread_silk(id);              break;
        case ITEM_T_CLOTH_T_PLANT:      buf->mutable_cloth()->add_thread_plant(id);             break;
        case ITEM_T_CLOTH_T_YARN:       buf->mutable_cloth()->add_thread_yarn(id);              break;
        case ITEM_T_CLOTH_T_METAL:      buf->mutable_cloth()->add_thread_metal(id);             break;
        case ITEM_T_CLOTH_SILK:         buf->mutable_cloth()->add_cloth_silk(id);               break;
        case ITEM_T_CLOTH_PLANT:        buf->mutable_cloth()->add_cloth_plant(id);              break;
        case ITEM_T_CLOTH_YARN:         buf->mutable_cloth()->add_cloth_yarn(id);               break;
        case ITEM_T_CLOTH_METAL:        buf->mutable_cloth()->add_cloth_metal(id);              break;
        case ITEM_T_WEAP_TYPE:          buf->mutable_weapons()->add_weapon_type(id);            break;
        case ITEM_T_WEAP_TYPE_T:        buf->mutable_weapons()->add_trapcomp_type(id);          break;
        case ITEM_T_WEAP_MATS:          buf->mutable_weapons()->add_mats(id);                   break;
        case ITEM_T_WEAP_MATS_O:        buf->mutable_weapons()->add_other_mats(id);             break;
        case ITEM_Q_WEAP_CORE:          buf->mutable_weapons()->add_quality_core(id);           break;
        case ITEM_Q_WEAP_TOTAL:         buf->mutable_weapons()->add_quality_total(id);          break;
        case ITEM_T_ARMO_BODY:          buf->mutable_armor()->add_body(id);                     break;
        case ITEM_T_ARMO_HELM:          buf->mutable_armor()->add_head(id);                     break;
        case ITEM_T_ARMO_SHOES:         buf->mutable_armor()->add_feet(id);                     break;
        case ITEM_T_ARMO_GLOVES:        buf->mutable_armor()->add_hands(id);                    break;
        case ITEM_T_ARMO_PANTS:         buf->mutable_armor()->add_legs(id);                     break;
        case ITEM_T_ARMO_SHIELD:        buf->mutable_armor()->add_shield(id);                   break;
        case ITEM_T_ARMO_MATS:          buf->mutable_armor()->add_mats(id);                     break;
        case ITEM_T_ARMO_MATS_O:        buf->mutable_armor()->add_other_mats(id);               break;
        case ITEM_Q_ARMO_CORE:          buf->mutable_armor()->add_quality_core(id);             break;
        case ITEM_Q_ARMO_TOTAL:         buf->mutable_armor()->add_quality_total(id);            break;
        default:                                                                                break;
    }
}
